                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active show" id="months-tab" data-toggle="tab"
                                                href="#months" role="tab" aria-controls="months" aria-selected="true">
                                                Months</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="months" role="tabpanel"
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/05.jpg') }}" alt="">
                                        </div>
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/02.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/03.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/04.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                ...
                                <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/09.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <h6 class="mb-0 sm-mt-5">Walk out 10 years into</h6>
                                            <p class="sm-mb-5 d-block">Understanding the price and having the willingness
                                                to
                                                pay. </p>
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/06.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <h6 class="mb-0 sm-mt-5">Step out on to the path</h6>
                                            <p class="sm-mb-5 d-block">Success to you and then pull it out when you are.
                                            </p>
                                    ...
                                    <div class="row mb-30">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/07.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <h6 class="mb-0 sm-mt-5">Briefly imagine that you</h6>
                                            <p class="sm-mb-5 d-block">Motivators for your personality and your personal
                                                goals.
                                            </p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-6">
                                            <img class="img-fluid"
                                                src="{{ asset('fileofdesgin_dashbord/images/blog/08.jpg') }}" alt="">
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <h6 class="mb-0 sm-mt-5">You continue doing what</h6>
                                            <p class="sm-mb-5 d-block">The first thing to remember about success is that.
                                            </p>
                        ...
                        <ul class="list-unstyled">
                                ...
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('fileofdesgin_dashbord/images/item/01.png') }}" alt="">
                                    </div>
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('fileofdesgin_dashbord/images/item/02.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li class="mb-20">
                                <div class="media">
                                    <div class="position-relative">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('fileofdesgin_dashbord/images/item/03.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="media">
                                    <div class="position-relative clearfix">
                                        <img class="img-fluid mr-15 avatar-small"
                                            src="{{ asset('fileofdesgin_dashbord/images/item/04.png') }}" alt="">
                                    </div>
                                    <div class="media-body">
            ...
            <div class="col-xl-4 mb-30">
                <div class="card card-statistics h-100">
                    <div class="p-4 text-center bg"
                        style="background: asset({{ asset('fileofdesgin_dashbord/images/bg/01.jpg') }});">
                    ...
                    <div class="card-body text-center position-relative">
                        <div class="avatar-top">
                            <img class="img-fluid w-25 rounded-circle "
                                src="{{ asset('fileofdesgin_dashbord/images/team/13.jpg') }}" alt="">
                        </div>
                        <div class="row">
